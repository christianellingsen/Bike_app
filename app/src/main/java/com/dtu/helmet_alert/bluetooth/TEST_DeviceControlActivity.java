 ...
 * Bluetooth LE API.
 */
public class TEST_DeviceControlActivity extends Activity {
    private final static String TAG = TEST_DeviceControlActivity.class.getSimpleName();
  ...
  //      getActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    protected void onResume() {
        ...
        if (mBluetoothLeService != null) {
            ...
            Log.d(TAG,"mBluetoothLeSerivce = null");
        }
    }
